...
function updateLopData() {
  ...
  document.getElementById(
    "lop-calendar-title"
  ).textContent = `${monthDropdown.options[month].text} ${year}`;
                ...
                .then((querySnapshot) => {
                  querySnapshot.forEach((doc) => {
                    ...
                    const dateCell = document.querySelector(
                      `.day-cell[data-date="${leaveDate.getFullYear()}-${
                  ...
                  document.getElementById(
                    "total-paid-days"
                  ).textContent = `Total Paid Days: ${totalPaidDays}`;
                  document.getElementById(
                    "full-lop-days"
                  ).textContent = `Full LOP Days: ${fullLopDays}`;
                  document.getElementById(
                    "half-lop-days"
                  ).textContent = `Half LOP Days: ${halfLopDays}`;
                })
                .catch((error) => {
