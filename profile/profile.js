                  ...
                  rankingSnapshot.forEach((rankingDoc) => {
                    ...
                    db.collection("attendance_register")
                      ...
                      .then((registerSnapshot) => {
                        ...
                        document.getElementById(
                          "emp-id"
                        ).innerText = `Trainee ID: ${employee.emp_id}`;
                        document.getElementById(
                          "emp-points"
                        ).innerText = `Trainee points: ${ranking.total_points}`;
                        document.getElementById(
                          "total-attendance"
                        ).innerText = `Total Attendance: ${
